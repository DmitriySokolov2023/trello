...
export class PomodoroService {
  ...
  async getTodaySession(userId: string) {
    ...
    return this.prisma.pomodoroSessions.findFirst({
      where: {
        createdAt: {
          gte: new Date(today),
        },
  ...
  async create(userId: string) {
    ...
    return this.prisma.pomodoroSessions.create({
      data: {
        rounds: {
          createMany: {
  ...
  async update(
    ...
    return this.prisma.pomodoroSessions.update({
      where: {
        userId,
        id: pomodoroId,
      },
  ...
  async deleteSession(sessionId: string, userId: string) {
    return this.prisma.pomodoroSessions.delete({
      where: {
        id: sessionId,
        userId,
      },
